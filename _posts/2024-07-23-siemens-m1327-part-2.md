...
![Closeup of the battery units](/blarg/assets/20240732/battery-cells.jpg)

Redrawing this in KiCad close to the actual layout on the die:

![Initial schematic of a single unit](/blarg/assets/20240732/cell-schematic-initial.png)
